...
variable_profiling_function  <- function(dv,var){
  ...
  ggplot( var1_profiling , aes(x=var1_profiling$Variable_Response, y=var1_profiling$Percentage))+ 
    ...
    annotate("text",x=1, y= z+2, label = paste("Overall Average",dv,"Rate = ",round(z,0),"%"),fontface='bold',hjust=0) +
